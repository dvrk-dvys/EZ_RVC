def download_dict():
    return {
        "vec768l12": {
            ...
            "output": "./model_dir/pretrain/checkpoint_best_legacy_500.pt"
        },
        "vec256l9": {
            "url": "https://ibm.ent.box.com/shared/static/z1wgl1stco8ffooyatzdwsqn2psd9lrr",
            "output": "./model_dir/pretrain/checkpoint_best_legacy_500.pt"
        ...
        "whisper-ppg-small": {
            ...
            "output": "./model_dir/pretrain/small.pt"
        },
        "whisper-ppg": {
            "url": "https://openaipublic.azureedge.net/main/whisper/models/345ae4da62f9b3d59415adc60127b97c714f32e89e936602e85993674d08dcb1/medium.pt",
            "output": "./model_dir/pretrain/medium.pt"
        },
        "whisper-ppg-large": {
            ...
            "output": "./model_dir/pretrain/large-v2.pt"
        }
    }
