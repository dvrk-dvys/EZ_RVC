# from transformers import Tacotron2ForConditionalGeneration, Tacotron2Tokenizer, WaveGlowForConditionalGeneration
# tacotron2 = Tacotron2ForConditionalGeneration.from_pretrained("tts_models/tacotron2-english")
# tokenizer = Tacotron2Tokenizer.from_pretrained("tts_models/tacotron2-english")
# waveglow = WaveGlowForConditionalGeneration.from_pretrained("tts_models/waveglow-english")
...
def plot():
    ...
    for i in range(3):
        ...
        fig.savefig("tacotron_waveform_plot.png")
