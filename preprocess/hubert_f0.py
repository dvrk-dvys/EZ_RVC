...
# from f0_crepe import CREPEPitchExtractor
from preprocess_hubert_f0 import process_one
...
if __name__ == "__main__":
    ...
    source_dir = '/path/to/your/wav/files'
    filenames = [os.path.join(source_dir, f) for f in os.listdir(source_dir) if f.endswith('.wav')]

    # Process each wav file
    for filename in filenames:
        process_one(filename, hmodel, f0p, device, diff=True, mel_extractor=mel_extractor)
