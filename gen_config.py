...
import argparse
template_path = "/Users/jordanharris/Code/PycharmProjects/EZ_RVC/preprocess/configs_template/config_template.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_list", type=str, default="./filelists/test.txt", help="path to train list")
    ...
    print()
    x = preprocess_config(
        input_dir='/output/sza_diairized_slices',
        train_list_path=args.train_list,
        val_list_path=args.val_list,
        test_list_path=args.test_list,
        config_path='/Users/jordanharris/Code/PycharmProjects/EZ_RVC/preprocess/configs',
