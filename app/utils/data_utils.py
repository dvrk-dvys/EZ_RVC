...
from app.models.layers.mel_processing import spectrogram_torch
from app.utils.utils import load_filepaths_and_text, load_wav_to_torch
...
class TextAudioSpeakerLoader(torch.utils.data.Dataset):
    ...
    def get_audio(self, filename):
        ...
        if len(self.hparams.spk) == 1:
            spk = list(self.hparams.spk.keys())[0]
        else:
