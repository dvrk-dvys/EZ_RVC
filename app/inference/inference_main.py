...
def main():
    ...
    parser.add_argument(
        ...
        "--model_path",
        type=str,
        default="/Users/jordanharris/Code/PycharmProjects/EZ_RVC/model_dir/cruz/G_172500.pth",
        help="模型路径",
    )
    parser.add_argument(
        "-c",
    ...
    parser.add_argument(
        ...
        type=str,
        default="/Users/jordanharris/Code/PycharmProjects/EZ_RVC/model_dir/model_0.pt",
        help="扩散模型路径",
    )
    parser.add_argument(
        "-dc",
